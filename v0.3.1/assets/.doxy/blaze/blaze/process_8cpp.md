...
| Type | Name |
| ---: | :--- |
|  [**GeoGrid**](classGeo.md)&lt; std::optional&lt; std::byte &gt; &gt; | [**downsample\_mask\_any**](#function-downsample_mask_any) (const [**GeoGrid**](classGeo.md)&lt; std::optional&lt; std::byte &gt; &gt; & grid, size\_t factor) <br> |
