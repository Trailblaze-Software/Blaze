...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="0" maxScale="0" minScale="100000" readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Rendering" symbologyReferenceScale="-1" version="3.34.3-Prizren">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="RuleRenderer">
    <rules key="{br-root}">
      <rule filter="&quot;barrier&quot; IN ('wall','city_wall','retaining_wall')" key="{br-wall}" label="Wall" scalemaxdenom="30000" scalemindenom="1000" symbol="0"></rule>
      <rule filter="&quot;barrier&quot; IN ('hedge')" key="{br-hedge}" label="Hedge" scalemaxdenom="20000" scalemindenom="1000" symbol="1"></rule>
      <rule filter="&quot;barrier&quot; IN ('ditch','trench')" key="{br-ditch}" label="Ditch / trench" scalemaxdenom="30000" scalemindenom="1000" symbol="2"></rule>
      <rule filter="ELSE" key="{br-fence}" label="Fence / other" symbol="3">
        <rule key="{80fbb388-5376-4865-a8bf-a9a76402f99b}" label="0 - 20000" scalemaxdenom="20000" symbol="4"></rule>
        <rule key="{0bf3f788-e513-4d0f-a52b-2bbdda466332}" label="20000 - 0" scalemindenom="20000" symbol="5"></rule>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="3" type="line">
        ...
        <layer class="SimpleLine" enabled="1" id="{pwr-line-base}" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="draw_inside_polygon" type="QString" value="0"></Option>
            <Option name="joinstyle" type="QString" value="round"></Option>
            <Option name="line_color" type="QString" value="0,0,0,0"></Option>
            <Option name="line_style" type="QString" value="solid"></Option>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="5" type="line">
        ...
        <layer class="SimpleLine" enabled="1" id="{pwr-line-base}" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="draw_inside_polygon" type="QString" value="0"></Option>
            <Option name="joinstyle" type="QString" value="round"></Option>
            <Option name="line_color" type="QString" value="0,0,0,150"></Option>
            <Option name="line_style" type="QString" value="solid"></Option>
