  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="fill">
        <layer class="SimpleFill" enabled="1" id="{osm-tourism-poly}" locked="0" pass="0">
          <Option type="Map">
            <Option name="color" type="QString" value="190,160,220,70"></Option>
            <Option name="outline_color" type="QString" value="90,70,120,255"></Option>
