...
<qgis hasScaleBasedVisibilityFlag="0" labelsEnabled="1" maxScale="0" minScale="1e+08" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Rendering" version="3.34.3-Prizren">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="marker">
        <layer class="SimpleMarker" enabled="1" id="{osm-tourism-pt}" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="120,80,160,255"></Option>
            <Option name="outline_color" type="QString" value="40,30,60,255"></Option>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" capitalization="1004" fieldName="name" fontFamily="Arial" fontSize="8" fontSizeUnit="Point" fontWeight="50" textColor="60,40,90,255" textOpacity="1">
      ...
      <placement dist="2" distUnits="MM" overlapHandling="PreventOverlap" placement="6" priority="5" quadOffset="2"></placement>
