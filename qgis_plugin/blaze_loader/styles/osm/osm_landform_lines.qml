...
<qgis hasScaleBasedVisibilityFlag="0" labelsEnabled="0" maxScale="0" minScale="1e+08" readOnly="0" styleCategories="LayerConfiguration|Symbology|Rendering" version="3.34.3-Prizren">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="RuleRenderer">
    <rules key="{lf-root}">
      <rule filter="&quot;natural&quot; = 'cliff'" key="{lf-cliff}" label="Cliff" symbol="0"></rule>
      <rule filter="ELSE" key="{lf-other}" label="Ridge / arete" symbol="1"></rule>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="line">
        <layer class="SimpleLine" enabled="1" id="{lf-cliff-base}" locked="0" pass="0">
          <Option type="Map">
        ...
        <layer class="MarkerLine" enabled="1" id="{lf-cliff-tags}" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="interval" type="QString" value="2.2"></Option>
          ...
          <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="@0@1" type="marker">
            <layer class="SimpleMarker" enabled="1" id="{lf-cliff-tag-marker}" locked="0" pass="0">
              <Option type="Map">
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="1" type="line">
        <layer class="SimpleLine" enabled="1" id="{lf-ridge-base}" locked="0" pass="0">
          <Option type="Map">
