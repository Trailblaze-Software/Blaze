...
<qgis hasScaleBasedVisibilityFlag="0" labelsEnabled="1" maxScale="0" minScale="1e+08" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Rendering" version="3.34.3-Prizren">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="fill">
        <layer class="SimpleFill" enabled="1" id="{osm-protected}" locked="0" pass="0">
          <Option type="Map">
            <Option name="color" type="QString" value="120,200,120,40"></Option>
            <Option name="outline_color" type="QString" value="50,130,50,255"></Option>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" capitalization="1004" fieldName="name" fontFamily="Arial" fontSize="9" fontSizeUnit="Point" fontWeight="63" textColor="30,90,30,255" textOpacity="1">
      ...
      <rendering drawLabels="1" obstacle="1" scaleMax="150000" scaleMin="0" scaleVisibility="1"></rendering>
    </settings>
  </labeling>
