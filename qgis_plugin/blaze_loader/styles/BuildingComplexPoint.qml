...
<qgis hasScaleBasedVisibilityFlag="0" labelsEnabled="1" maxScale="0" minScale="100000000" readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering" symbologyReferenceScale="-1" version="3.34.3-Prizren">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="marker">
        ...
        <layer class="SimpleMarker" enabled="1" id="{8681029f-2f26-4dd8-92ac-01d2e3fd25dd}" locked="0" pass="0">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="marker">
        ...
        <layer class="SimpleMarker" enabled="1" id="{dc0e8935-5f68-4b11-bfc4-6914865dad98}" locked="0" pass="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"></Option>
            <Option name="cap_style" type="QString" value="square"></Option>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" blendMode="0" capitalization="1004" fieldName="case when &quot;generalname&quot; is NULL then '' else '\'' + &quot;generalname&quot; + '\'' end" fontFamily="Open Sans" fontItalic="1" fontKerning="1" fontLetterSpacing="0" fontSize="6" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="57" fontWordSpacing="0" forcedBold="0" forcedItalic="0" isExpression="1" legendString="Aa" multilineHeight="1" multilineHeightUnit="Percentage" namedStyle="Medium Italic" previewBkgrdColor="255,255,255,255" textColor="50,50,50,255" textOpacity="1" textOrientation="horizontal" useSubstitutions="0">
        <families></families>
        <text-buffer bufferBlendMode="0" bufferColor="250,250,250,255" bufferDraw="1" bufferJoinStyle="128" bufferNoFill="1" bufferOpacity="1" bufferSize="0.17000000000000001" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM"></text-buffer>
      ...
      <placement allowDegraded="0" centroidInside="0" centroidWhole="0" dist="1.2" distMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" fitInPolygonOnly="0" geometryGenerator="" geometryGeneratorEnabled="0" geometryGeneratorType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" lineAnchorClipping="0" lineAnchorPercent="0.5" lineAnchorTextPoint="FollowPlacement" lineAnchorType="0" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" offsetType="0" offsetUnits="MM" overlapHandling="PreventOverlap" overrunDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" placement="6" placementFlags="10" polygonPlacementFlags="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" priority="6" quadOffset="2" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" rotationAngle="0" rotationUnit="AngleDegrees" xOffset="0" yOffset="0"></placement>
        ...
        <Option type="Map">
          ...
          <Option name="properties" type="Map">
            <Option name="PredefinedPositionOrder" type="Map">
              ...
              <Option name="expression" type="QString" value="'TR,TSR,TL,T,TSL,BR,BSR,BL,BSL,B,L,R'"></Option>
    ...
    <DiagramCategory backgroundAlpha="255" backgroundColor="#ffffff" barWidth="5" diagramOrientation="Up" direction="0" enabled="0" height="15" labelPlacementMethod="XHeight" lineSizeScale="3x:0,0,0,0,0,0" lineSizeType="MM" maxScaleDenominator="1e+08" minScaleDenominator="0" minimumSize="0" opacity="1" penAlpha="255" penColor="#000000" penWidth="0" rotationOffset="270" scaleBasedVisibility="0" scaleDependency="Area" showAxis="1" sizeScale="3x:0,0,0,0,0,0" sizeType="MM" spacing="5" spacingUnit="MM" spacingUnitScale="3x:0,0,0,0,0,0" width="15">
      ...
      <axisSymbol>
        <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="line">
          ...
          <layer class="SimpleLine" enabled="1" id="{51ee00f8-1e31-46f2-a045-245a7e4b32bc}" locked="0" pass="0">
            <Option type="Map">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="buildingcomplextype">
      <editWidget type="Range">
        <config>
          <Option></Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="buildingcomplextype" index="17" name=""></alias>
  ...
  <splitPolicies>
    ...
    <policy field="buildingcomplextype" policy="Duplicate"></policy>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="buildingcomplextype"></default>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="buildingcomplextype" notnull_strength="0" unique_strength="0"></constraint>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="buildingcomplextype"></constraint>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="buildingcomplextype" type="field" width="-1"></column>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="buildingcomplextype"></field>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="buildingcomplextype"></field>
  ...
  <reuseLastValue>
    ...
    <field name="buildingcomplextype" reuseLastValue="0"></field>
