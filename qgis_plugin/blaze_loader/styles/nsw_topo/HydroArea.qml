...
<qgis hasScaleBasedVisibilityFlag="0" labelsEnabled="0" maxScale="0" minScale="100000000" readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" version="3.34.5-Prizren">
  <flags>
  ...
  <elevation binding="Centroid" clamping="Relative" extrusion="0" extrusionEnabled="0" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0" symbology="Line" type="IndividualFeatures" zoffset="0" zscale="1">
    ...
    <profileLineSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="line">
        ...
        <layer class="SimpleLine" enabled="1" id="{277682fc-2fe9-457a-8881-6c9fd7e9490f}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{d2633355-ee59-40c5-afb8-5bebca68cc95}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="marker">
        ...
        <layer class="SimpleMarker" enabled="1" id="{93f54fe6-45aa-4986-9ffe-b21d436e5153}" locked="0" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{2f0920ca-2345-438e-8395-7bb1703c58dd}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="color" type="QString" value="207,247,252,255"></Option>
            <Option name="joinstyle" type="QString" value="bevel"></Option>
            <Option name="offset" type="QString" value="0,0"></Option>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="offset_unit" type="QString" value="MM"></Option>
            <Option name="outline_color" type="QString" value="2,192,255,255"></Option>
            <Option name="outline_style" type="QString" value="solid"></Option>
            <Option name="outline_width" type="QString" value="0.7"></Option>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{d0870520-f715-4222-ab56-f7f999756b10}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style allowHtml="0" blendMode="0" capitalization="1004" fieldName="trim(&quot;hydroname&quot; || ' ' ||  &quot;hydronametype&quot;)" fontFamily="MS Shell Dlg 2" fontItalic="0" fontKerning="1" fontLetterSpacing="0" fontSize="10" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="50" fontWordSpacing="0" forcedBold="0" forcedItalic="0" isExpression="1" legendString="Aa" multilineHeight="1" multilineHeightUnit="Percentage" namedStyle="Regular" previewBkgrdColor="255,255,255,255" textColor="50,50,50,255" textOpacity="1" textOrientation="horizontal" useSubstitutions="0">
        <families></families>
    ...
    <DiagramCategory backgroundAlpha="255" backgroundColor="#ffffff" barWidth="5" diagramOrientation="Up" direction="0" enabled="0" height="15" labelPlacementMethod="XHeight" lineSizeScale="3x:0,0,0,0,0,0" lineSizeType="MM" maxScaleDenominator="1e+08" minScaleDenominator="0" minimumSize="0" opacity="1" penAlpha="255" penColor="#000000" penWidth="0" rotationOffset="270" scaleBasedVisibility="0" scaleDependency="Area" showAxis="1" sizeScale="3x:0,0,0,0,0,0" sizeType="MM" spacing="5" spacingUnit="MM" spacingUnitScale="3x:0,0,0,0,0,0" width="15">
      ...
      <axisSymbol>
        <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="line">
          ...
          <layer class="SimpleLine" enabled="1" id="{d95a956b-8105-41f0-8dad-15d742c467f1}" locked="0" pass="0">
            <Option type="Map">
              <Option name="align_dash_pattern" type="QString" value="0"></Option>
              <Option name="capstyle" type="QString" value="square"></Option>
              <Option name="customdash" type="QString" value="5;2"></Option>
  ...
  <fieldConfiguration>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="Original 1:25000 Mapping Program" type="qlonglong" value="1"></Option>
              </Option>
              <Option type="Map">
                <Option name="First PSMA Capture Program" type="qlonglong" value="2"></Option>
              </Option>
              <Option type="Map">
                <Option name="Penguin Rd Atlas Capture Program" type="qlonglong" value="3"></Option>
              </Option>
              <Option type="Map">
                <Option name="Standard Topographic Capture Program" type="qlonglong" value="4"></Option>
              </Option>
              <Option type="Map">
                <Option name="Original 1:50000 Mapping Program" type="qlonglong" value="5"></Option>
              </Option>
              <Option type="Map">
                <Option name="Original 1:100000 Mapping Program" type="qlonglong" value="6"></Option>
              </Option>
              <Option type="Map">
                <Option name="RFS Field Update Program" type="qlonglong" value="7"></Option>
              </Option>
              <Option type="Map">
                <Option name="ABS Cen2001 Update Program" type="qlonglong" value="8"></Option>
              </Option>
              <Option type="Map">
                <Option name="Western Div. Capture  Program" type="qlonglong" value="9"></Option>
              </Option>
              <Option type="Map">
                <Option name="State Forests Data Integration Program" type="qlonglong" value="10"></Option>
              </Option>
              <Option type="Map">
                <Option name="NPWS Data Integration Program" type="qlonglong" value="11"></Option>
              </Option>
              <Option type="Map">
                <Option name="ACT Govt Data Integration Program" type="qlonglong" value="12"></Option>
              </Option>
              <Option type="Map">
                <Option name="Large Scale 1 metre Contour Interval Mapping" type="qlonglong" value="13"></Option>
              </Option>
              <Option type="Map">
                <Option name="Large Scale 2 metre Contour Interval Mapping" type="qlonglong" value="14"></Option>
              </Option>
              <Option type="Map">
                <Option name="DTM Derived Small Scale Contours" type="qlonglong" value="15"></Option>
              </Option>
              <Option type="Map">
                <Option name="LPI DTDB line segments" type="qlonglong" value="16"></Option>
              </Option>
              <Option type="Map">
                <Option name="DCDB Road Corridor Centreline Program" type="qlonglong" value="17"></Option>
              </Option>
              <Option type="Map">
                <Option name="RIC Railways Integration Program" type="qlonglong" value="19"></Option>
              </Option>
              <Option type="Map">
                <Option name="GURAS Roads Update Program" type="qlonglong" value="21"></Option>
              </Option>
              <Option type="Map">
                <Option name="Commonwealth Govt (Geoscience Aust) Topo Update Program" type="qlonglong" value="22"></Option>
              </Option>
              <Option type="Map">
                <Option name="Crown Land Road Integration Program" type="qlonglong" value="23"></Option>
              </Option>
              <Option type="Map">
                <Option name="Murray Irrigation Canal Integration Program" type="qlonglong" value="24"></Option>
              </Option>
              <Option type="Map">
                <Option name="RTA Classified Roads Integration Program" type="qlonglong" value="18"></Option>
              </Option>
              <Option type="Map">
                <Option name="Local Govt Roads Data Integration Program" type="qlonglong" value="20"></Option>
              </Option>
              <Option type="Map">
                <Option name="RTA Non-Classified Roads Integration Program" type="qlonglong" value="25"></Option>
              </Option>
              <Option type="Map">
                <Option name="Forests NSW Data Integration Program" type="qlonglong" value="26"></Option>
              </Option>
              <Option type="Map">
                <Option name="RTA Roads Pending Validation Program" type="qlonglong" value="27"></Option>
              </Option>
              <Option type="Map">
                <Option name="Points of Interest Update Program" type="qlonglong" value="28"></Option>
              </Option>
              <Option type="Map">
                <Option name="Hydrography Update Program" type="qlonglong" value="29"></Option>
              </Option>
              <Option type="Map">
                <Option name="RFS Notification Edit Service" type="qlonglong" value="30"></Option>
              </Option>
              <Option type="Map">
                <Option name="Police NSW" type="qlonglong" value="31"></Option>
              </Option>
              <Option type="Map">
                <Option name="Fire and Rescue NSW" type="qlonglong" value="32"></Option>
              </Option>
              <Option type="Map">
                <Option name="State Emergency Services NSW" type="qlonglong" value="33"></Option>
              </Option>
              <Option type="Map">
                <Option name="Rural Fire Service NSW" type="qlonglong" value="34"></Option>
              </Option>
              <Option type="Map">
                <Option name="Surf Life Saving Association NSW" type="qlonglong" value="36"></Option>
              </Option>
              <Option type="Map">
                <Option name="Local Council" type="qlonglong" value="37"></Option>
              </Option>
              <Option type="Map">
                <Option name="Transport NSW" type="qlonglong" value="38"></Option>
              </Option>
              <Option type="Map">
                <Option name="Civil Aviation Safety Authority" type="qlonglong" value="39"></Option>
              </Option>
              <Option type="Map">
                <Option name="Roads and Maritime Services NSW" type="qlonglong" value="40"></Option>
              </Option>
              <Option type="Map">
                <Option name="Fair Trading NSW" type="qlonglong" value="41"></Option>
              </Option>
              <Option type="Map">
                <Option name="Health NSW" type="qlonglong" value="42"></Option>
              </Option>
              <Option type="Map">
                <Option name="Clubs NSW" type="qlonglong" value="43"></Option>
              </Option>
              <Option type="Map">
                <Option name="Board of Studies NSW" type="qlonglong" value="44"></Option>
              </Option>
              <Option type="Map">
                <Option name="Department of Education and Communities NSW" type="qlonglong" value="45"></Option>
              </Option>
              <Option type="Map">
                <Option name="Attorney General's Department NSW" type="qlonglong" value="46"></Option>
              </Option>
              <Option type="Map">
                <Option name="Department of Foreign Affairs and Trade" type="qlonglong" value="47"></Option>
              </Option>
              <Option type="Map">
                <Option name="Corrective Services NSW" type="qlonglong" value="48"></Option>
              </Option>
              <Option type="Map">
                <Option name="Department of Local Government NSW" type="qlonglong" value="49"></Option>
              </Option>
              <Option type="Map">
                <Option name="Department of Primary Industries NSW" type="qlonglong" value="50"></Option>
              </Option>
              <Option type="Map">
                <Option name="Department of Health and Aging" type="qlonglong" value="51"></Option>
              </Option>
              <Option type="Map">
                <Option name="Australia Post" type="qlonglong" value="52"></Option>
              </Option>
              <Option type="Map">
                <Option name="Trade and Investment NSW" type="qlonglong" value="53"></Option>
              </Option>
              <Option type="Map">
                <Option name="Tourism NSW" type="qlonglong" value="54"></Option>
              </Option>
              <Option type="Map">
                <Option name="Ambulance NSW" type="qlonglong" value="35"></Option>
              </Option>
            </Option>
          </Option>
        </config>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="Undefined" type="qlonglong" value="0"></Option>
              </Option>
              <Option type="Map">
                <Option name="Registered Image Trace" type="qlonglong" value="1"></Option>
              </Option>
              <Option type="Map">
                <Option name="Ortho Image Trace" type="qlonglong" value="2"></Option>
              </Option>
              <Option type="Map">
                <Option name="Table Digitisation" type="qlonglong" value="3"></Option>
              </Option>
              <Option type="Map">
                <Option name="DCDB trace" type="qlonglong" value="4"></Option>
              </Option>
              <Option type="Map">
                <Option name="Scan / Vectorize" type="qlonglong" value="8"></Option>
              </Option>
              <Option type="Map">
                <Option name="Differential GPS" type="qlonglong" value="9"></Option>
              </Option>
              <Option type="Map">
                <Option name="Non corrected GPS" type="qlonglong" value="10"></Option>
              </Option>
              <Option type="Map">
                <Option name="GPS with estimated correction" type="qlonglong" value="11"></Option>
              </Option>
              <Option type="Map">
                <Option name="Comparative estimate (eyeballed)" type="qlonglong" value="12"></Option>
              </Option>
              <Option type="Map">
                <Option name="Survey Controlled" type="qlonglong" value="13"></Option>
              </Option>
              <Option type="Map">
                <Option name="Mobile GPS" type="qlonglong" value="14"></Option>
              </Option>
              <Option type="Map">
                <Option name="Intersection point by FN resection" type="qlonglong" value="15"></Option>
              </Option>
              <Option type="Map">
                <Option name="Stereo Image Trace" type="qlonglong" value="16"></Option>
              </Option>
              <Option type="Map">
                <Option name="Engineering Design File (CAD)" type="qlonglong" value="18"></Option>
              </Option>
              <Option type="Map">
                <Option name="Scanned Map Image Trace" type="qlonglong" value="19"></Option>
              </Option>
              <Option type="Map">
                <Option name="Aggregation or replication of existing line segments" type="qlonglong" value="17"></Option>
              </Option>
              <Option type="Map">
                <Option name="Positioned within features cadastral or ortho image extent Positioned within features cadastral or ortho image extent" type="qlonglong" value="20"></Option>
              </Option>
            </Option>
          </Option>
        </config>
    ...
    <field configurationFlags="NoFlag" name="hydronameoid">
      <editWidget type="TextEdit">
        <config>
          <Option></Option>
        </config>
    ...
    <field configurationFlags="NoFlag" name="hydroname">
      <editWidget type="TextEdit">
        <config>
          <Option></Option>
        </config>
    ...
    <field configurationFlags="NoFlag" name="hydronametype">
      <editWidget type="TextEdit">
        <config>
          <Option></Option>
        </config>
    ...
    <field configurationFlags="NoFlag" name="perenniality">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="NotApplicable" type="qlonglong" value="0"></Option>
              </Option>
              <Option type="Map">
                <Option name="Perennial" type="qlonglong" value="1"></Option>
              </Option>
              <Option type="Map">
                <Option name="NonPerennial" type="qlonglong" value="2"></Option>
              </Option>
              <Option type="Map">
                <Option name="MainlyDry" type="qlonglong" value="3"></Option>
              </Option>
            </Option>
          </Option>
        </config>
    ...
    <field configurationFlags="NoFlag" name="hydrotype">
    ...
    <field configurationFlags="NoFlag" name="Shape__Length">
      <editWidget type="TextEdit">
        <config>
          <Option></Option>
        </config>
    ...
    <field configurationFlags="NoFlag" name="Shape__Area">
      <editWidget type="TextEdit">
        <config>
          <Option></Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="OBJECTID" index="1" name="RID"></alias>
    <alias field="topoid" index="2" name="TopoID"></alias>
    ...
    <alias field="classsubtype" index="6" name="ClassSubtype"></alias>
    ...
    <alias field="hydronameoid" index="13" name=""></alias>
    <alias field="hydroname" index="14" name=""></alias>
    <alias field="hydronametype" index="15" name=""></alias>
    <alias field="perenniality" index="16" name="Perenniality"></alias>
    <alias field="hydrotype" index="17" name=""></alias>
    ...
    <alias field="Shape__Length" index="28" name="shape_Length"></alias>
    <alias field="Shape__Area" index="29" name="shape_Area"></alias>
  </aliases>
  <splitPolicies>
    ...
    <policy field="hydronameoid" policy="Duplicate"></policy>
    <policy field="hydroname" policy="Duplicate"></policy>
    <policy field="hydronametype" policy="Duplicate"></policy>
    <policy field="perenniality" policy="Duplicate"></policy>
    <policy field="hydrotype" policy="Duplicate"></policy>
    ...
    <policy field="Shape__Length" policy="Duplicate"></policy>
    <policy field="Shape__Area" policy="Duplicate"></policy>
  </splitPolicies>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="hydronameoid"></default>
    <default applyOnUpdate="0" expression="" field="hydroname"></default>
    <default applyOnUpdate="0" expression="" field="hydronametype"></default>
    <default applyOnUpdate="0" expression="" field="perenniality"></default>
    <default applyOnUpdate="0" expression="" field="hydrotype"></default>
    ...
    <default applyOnUpdate="0" expression="" field="Shape__Length"></default>
    <default applyOnUpdate="0" expression="" field="Shape__Area"></default>
  </defaults>
  <constraints>
    <constraint constraints="3" exp_strength="0" field="fid" notnull_strength="1" unique_strength="1"></constraint>
    <constraint constraints="3" exp_strength="0" field="OBJECTID" notnull_strength="1" unique_strength="1"></constraint>
    ...
    <constraint constraints="0" exp_strength="0" field="hydronameoid" notnull_strength="0" unique_strength="0"></constraint>
    <constraint constraints="0" exp_strength="0" field="hydroname" notnull_strength="0" unique_strength="0"></constraint>
    <constraint constraints="0" exp_strength="0" field="hydronametype" notnull_strength="0" unique_strength="0"></constraint>
    <constraint constraints="1" exp_strength="0" field="perenniality" notnull_strength="1" unique_strength="0"></constraint>
    <constraint constraints="1" exp_strength="0" field="hydrotype" notnull_strength="1" unique_strength="0"></constraint>
    ...
    <constraint constraints="0" exp_strength="0" field="Shape__Length" notnull_strength="0" unique_strength="0"></constraint>
    <constraint constraints="0" exp_strength="0" field="Shape__Area" notnull_strength="0" unique_strength="0"></constraint>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="hydronameoid"></constraint>
    <constraint desc="" exp="" field="hydroname"></constraint>
    <constraint desc="" exp="" field="hydronametype"></constraint>
    <constraint desc="" exp="" field="perenniality"></constraint>
    <constraint desc="" exp="" field="hydrotype"></constraint>
    ...
    <constraint desc="" exp="" field="Shape__Length"></constraint>
    <constraint desc="" exp="" field="Shape__Area"></constraint>
  </constraintExpressions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="hydronameoid" type="field" width="-1"></column>
      <column hidden="0" name="hydroname" type="field" width="-1"></column>
      <column hidden="0" name="hydronametype" type="field" width="-1"></column>
      <column hidden="0" name="perenniality" type="field" width="-1"></column>
      <column hidden="0" name="hydrotype" type="field" width="-1"></column>
      ...
      <column hidden="0" name="Shape__Length" type="field" width="-1"></column>
      <column hidden="0" name="Shape__Area" type="field" width="-1"></column>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="hydroname"></field>
    <field editable="1" name="hydronameoid"></field>
    <field editable="1" name="hydronametype"></field>
    <field editable="1" name="hydrotype"></field>
    <field editable="1" name="lastupdate"></field>
    <field editable="1" name="msoid"></field>
    <field editable="1" name="objectid"></field>
    <field editable="1" name="objectmoddate"></field>
    <field editable="1" name="perenniality"></field>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="hydroname"></field>
    <field labelOnTop="0" name="hydronameoid"></field>
    <field labelOnTop="0" name="hydronametype"></field>
    <field labelOnTop="0" name="hydrotype"></field>
    <field labelOnTop="0" name="lastupdate"></field>
    <field labelOnTop="0" name="msoid"></field>
    <field labelOnTop="0" name="objectid"></field>
    <field labelOnTop="0" name="objectmoddate"></field>
    <field labelOnTop="0" name="perenniality"></field>
  ...
  <reuseLastValue>
    ...
    <field name="hydroname" reuseLastValue="0"></field>
    <field name="hydronameoid" reuseLastValue="0"></field>
    <field name="hydronametype" reuseLastValue="0"></field>
    <field name="hydrotype" reuseLastValue="0"></field>
    ...
    <field name="perenniality" reuseLastValue="0"></field>
