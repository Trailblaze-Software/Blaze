...
<qgis hasScaleBasedVisibilityFlag="0" labelsEnabled="0" maxScale="0" minScale="100000000" readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering" symbologyReferenceScale="-1" version="3.34.3-Prizren">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="RuleRenderer">
    <rules key="{fc7f8887-5f44-45ee-abb4-ca68c9f97c15}">
      ...
      <rule filter="classsubtype = 7" key="{861f1e29-98bd-4f2b-99c6-ad90d3a1671d}" label="Urban" symbol="5"></rule>
      <rule filter="classsubtype = 9 and (generalculturaltype = 0 or generalculturaltype = 1)" key="{71ddb56f-7aa1-4a51-9ea3-5c761128746f}" label="Water treatment pond" symbol="6"></rule>
      <rule filter="ELSE" key="{37c0414f-269a-4713-b2cf-c47e26bccfca}" label="Unknown" symbol="7"></rule>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{91685feb-0984-4626-a087-727ac443cbfe}" locked="0" pass="0">
          <Option type="Map">
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="1" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{aaa0aad4-e3b1-48d5-873f-1f9a90bdc185}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            ...
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="offset_unit" type="QString" value="MM"></Option>
            <Option name="outline_color" type="QString" value="112,112,112,255"></Option>
            <Option name="outline_style" type="QString" value="solid"></Option>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="2" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{decbc817-7b23-45c3-b832-7329dfe95d45}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="color" type="QString" value="35,118,35,255"></Option>
            <Option name="joinstyle" type="QString" value="bevel"></Option>
            <Option name="offset" type="QString" value="0,0"></Option>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="offset_unit" type="QString" value="MM"></Option>
            <Option name="outline_color" type="QString" value="35,0,35,255"></Option>
      ...
      <symbol alpha="0.4" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="3" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""></Option>
            <Option name="properties"></Option>
        ...
        <layer class="SVGFill" enabled="1" id="{57a9c90f-d340-4ae9-8e25-1a3e48f1cde6}" locked="0" pass="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"></Option>
            <Option name="color" type="QString" value="0,136,0,255"></Option>
            <Option name="outline_color" type="QString" value="255,255,255,255"></Option>
            <Option name="outline_width" type="QString" value="0"></Option>
            ...
            <Option name="svgFile" type="QString" value="gpsicons/tree.svg"></Option>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="4" type="fill">
        ...
        <layer class="SVGFill" enabled="1" id="{3155aa06-85c4-42ca-b4b4-70ff5f82d97d}" locked="0" pass="0">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"></Option>
            <Option name="color" type="QString" value="35,118,35,255"></Option>
            <Option name="outline_color" type="QString" value="35,0,35,255"></Option>
            ...
            <Option name="pattern_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="pattern_width_unit" type="QString" value="MM"></Option>
            <Option name="svgFile" type="QString" value="symbol/landuse_deciduous.svg"></Option>
            <Option name="svg_outline_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="svg_outline_width_unit" type="QString" value="MM"></Option>
            <Option name="width" type="QString" value="1.5"></Option>
          </Option>
          <data_defined_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""></Option>
      ...
      <symbol alpha="0.326" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="5" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""></Option>
            <Option name="properties"></Option>
        ...
        <layer class="SimpleFill" enabled="1" id="{ba377a73-d66e-44a7-bae1-b1d1c56eaafc}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="color" type="QString" value="255,202,11,255"></Option>
            <Option name="joinstyle" type="QString" value="bevel"></Option>
            <Option name="offset" type="QString" value="0,0"></Option>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="offset_unit" type="QString" value="MM"></Option>
            <Option name="outline_color" type="QString" value="254,243,169,255"></Option>
            <Option name="outline_style" type="QString" value="no"></Option>
            <Option name="outline_width" type="QString" value="0"></Option>
            <Option name="outline_width_unit" type="QString" value="MM"></Option>
            <Option name="style" type="QString" value="solid"></Option>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="6" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{446fae80-c39b-4c1b-a5b4-95a43c83b326}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="color" type="QString" value="17,40,234,255"></Option>
            <Option name="joinstyle" type="QString" value="bevel"></Option>
            <Option name="offset" type="QString" value="0,0"></Option>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="offset_unit" type="QString" value="MM"></Option>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="7" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{64d0fc3d-6cc9-4fc2-8502-c9832fcd34e3}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
            <Option name="color" type="QString" value="255,0,0,255"></Option>
            <Option name="joinstyle" type="QString" value="bevel"></Option>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{32a57ac8-1f13-4f3e-a7e6-5831bdca5a4e}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"></Option>
    ...
    <DiagramCategory backgroundAlpha="255" backgroundColor="#ffffff" barWidth="5" diagramOrientation="Up" direction="0" enabled="0" height="15" labelPlacementMethod="XHeight" lineSizeScale="3x:0,0,0,0,0,0" lineSizeType="MM" maxScaleDenominator="1e+08" minScaleDenominator="0" minimumSize="0" opacity="1" penAlpha="255" penColor="#000000" penWidth="0" rotationOffset="270" scaleBasedVisibility="0" scaleDependency="Area" showAxis="1" sizeScale="3x:0,0,0,0,0,0" sizeType="MM" spacing="5" spacingUnit="MM" spacingUnitScale="3x:0,0,0,0,0,0" width="15">
      ...
      <axisSymbol>
        <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="line">
          ...
          <layer class="SimpleLine" enabled="1" id="{a489e696-3158-474e-a6c6-7e5369f49a92}" locked="0" pass="0">
            <Option type="Map">
  ...
  <aliases>
    ...
    <alias field="generalculturaltype" index="17" name=""></alias>
    ...
    <alias field="shape_Length" index="28" name=""></alias>
    <alias field="shape_Area" index="29" name=""></alias>
  </aliases>
  <splitPolicies>
    ...
    <policy field="generalculturaltype" policy="Duplicate"></policy>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="generalculturaltype"></default>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" field="generalculturaltype" notnull_strength="0" unique_strength="0"></constraint>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="generalculturaltype"></constraint>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="generalculturaltype" type="field" width="-1"></column>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="generalculturaltype"></field>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="generalculturaltype"></field>
  ...
  <reuseLastValue>
    ...
    <field name="generalculturaltype" reuseLastValue="0"></field>
